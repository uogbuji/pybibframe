#The Versa-based data model from the Dendrite project
...
#Based on akara.dendrite.connection_base; would subclass, but not wanting to add a req

class model:
    def __init__(self, baseuri=None, connstr=None, logger=None):
        '''
        '''
